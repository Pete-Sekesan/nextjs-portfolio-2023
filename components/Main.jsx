        ...
        <div id='home' className='w-full h-screen text-center'>
            <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
                <div>
                    ...
                    <p className='py-4 text-gray-600 max-w-[70%] m-auto'>I am a Software Engineer currently working as a Full-Stack Developer for Newsday Media Group in Melville,NY.
